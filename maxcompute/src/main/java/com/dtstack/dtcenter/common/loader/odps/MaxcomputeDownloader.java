...
public class MaxcomputeDownloader implements IDownloader {
    ...
    public MaxcomputeDownloader(Connection connection, String sql, String schema) {
    ...
    public void configure() throws Exception {
        ...
        try (
            ...
            throw new DtCenterDefException("构造 MaxComputer 下载器信息异常 : " + e.getMessage(), e);
        }
    }
    ...
    public List<List<String>> readNext() throws Exception {
        ...
        try (ResultSet resultSet = statement.executeQuery(limitSQL)) {
            ...
            throw new DtCenterDefException("读取 MaxComputer 信息异常 : " + e.getMessage(), e);
        }
