...
package com.dtstack.dtcenter.loader.cache.client.hbase;
...
public class HbaseProxy implements IHbase {
    ...
    @Override
    public Boolean createHbaseTable(ISourceDTO source, String namespace, String tableName, Map<String, String> colFamily) {
        return ClassLoaderCallBackMethod.callbackAndReset(() -> targetClient.createHbaseTable(source, namespace, tableName, colFamily),
                targetClient.getClass().getClassLoader());
    }
