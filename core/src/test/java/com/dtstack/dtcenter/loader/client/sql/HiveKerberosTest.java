 ...
 * @Author ：Nanqi
 * @Date ：Created in 17:27 2020/9/7
 * @Description：Hive2 Kerberos 认证
 */
public class HiveKerberosTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        kerberosConfig.put(HadoopConfTool.PRINCIPAL, "hive/eng-cdh1@DTSTACK.COM");
        kerberosConfig.put(HadoopConfTool.PRINCIPAL_FILE, "/hive-cdh01.keytab");
