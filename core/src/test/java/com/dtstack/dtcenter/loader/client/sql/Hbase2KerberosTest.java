 ...
 * @Author ：Nanqi
 * @Date ：Created in 11:57 2020/9/9
 * @Description：Hbase2 Kerberos 测试
 */
public class Hbase2KerberosTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        IKerberos kerberos = ClientCache.getKerberos(DataSourceType.HBASE2.getVal());
