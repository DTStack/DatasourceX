...
public class HiveTest {
    ...
    public void testCon() throws Exception {
        IClient client = clientCache.getClient(DataSourceClientType.HIVE.getPluginName());
        Map object = JSONObject.parseObject(krbStr);
        System.setProperty("java.security.krb5.conf", "/Users/jialongyan/Desktop/nanqi011/krb5.conf");
        source.setKerberosConfig(object);
