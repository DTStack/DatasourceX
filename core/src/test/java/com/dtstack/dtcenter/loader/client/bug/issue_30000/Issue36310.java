...
public class Issue36310 {
    ...
    public void test_for_issue() throws IOException {
        String zipPath = Issue36310.class.getResource("/bug/issue_36310/dir_kerberos.zip").getPath();
        IKerberos kerberos = ClientCache.getKerberos(DataSourceType.HIVE.getVal());
        kerberos.parseKerberosFromUpload(zipPath, Issue36310.class.getResource("/").getPath());
    }
}
