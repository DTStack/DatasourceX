...
public interface IClient<T> {
     ...
     * @throws Exception
     */
    Boolean createDatabase(ISourceDTO source, String dbName, String comment) throws Exception;
     ...
     * @throws Exception
     */
    Boolean isTableExistsInDatabase(ISourceDTO source, String tableName, String dbName) throws Exception;
