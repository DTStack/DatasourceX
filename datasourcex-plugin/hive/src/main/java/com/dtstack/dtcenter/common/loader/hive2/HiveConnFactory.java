...
import com.dtstack.dtcenter.common.loader.common.constant.CommonConstant;
...
public class HiveConnFactory extends ConnFactory {
     ...
     */
    private void setQueue(Properties properties, HiveSourceDTO hiveSourceDTO) {
    ...
    private void dealSsl(Properties properties, SSLUtil.SSLConfiguration sslConfiguration) {
        ...
        if (StringUtils.isBlank(storePath)) {
            throw new DtLoaderException("hive ssl Certification lack certificate path");
        }
