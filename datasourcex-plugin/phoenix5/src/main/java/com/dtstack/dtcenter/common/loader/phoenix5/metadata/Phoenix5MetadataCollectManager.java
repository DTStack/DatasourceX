 ...
 *
 * @author by zhiyi
 * @date 2022/4/11 3:13 下午
 */
public class Phoenix5MetadataCollectManager extends RdbmsMetaDataCollectManager {

    public Phoenix5MetadataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return Phoenix5MetadataCollect.class;
    }
}
