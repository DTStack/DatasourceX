                ...
                (PrivilegedAction<Connection>) () -> {
                    ...
                    if (MapUtils.isNotEmpty(kerberosConfig)) {
                        ...
                        if (StringUtils.isNotBlank(principal)) {
                            ...
                            props.setProperty(HadoopConfTool.HBASE_MASTER_PRINCIPAL, masterPrincipal);
                            props.setProperty(HadoopConfTool.HBASE_REGION_PRINCIPAL, masterPrincipal);
                            props.setProperty(HadoopConfTool.PHOENIX_QUERYSERVER_KERBEROS_PRINCIPAL, principal);
