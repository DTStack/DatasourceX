...
package com.dtstack.dtcenter.common.loader.hbase.metadata.util;
...
public class ZkHelper {
    ...
    public static ZooKeeper createZkClient(String hosts, int timeOut) {
        try {
            ...
            LOG.error("create zookeeper client failed. error ", e);
            return null;
        }
    }
    ...
    public static long getCreateTime(ZooKeeper zooKeeper, String path) {
        ...
        if (zooKeeper != null) {
            try {
                ...
                LOG.error("failed to get create time of {} ", path, e);
                return 0L;
            }
        } else {
            return 0L;
    ...
    public static List<String> getChildren(ZooKeeper zooKeeper, String path) {
        if (zooKeeper != null) {
            try {
                ...
                LOG.error("failed to get children, path :{} ", path, e);
                return null;
            }
