 ...
 * @date 2022/4/13
 */
public class HbaseMetadataCollectManager extends AbstractMetaDataCollectManager {
    public HbaseMetadataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return HbaseMetadataCollect.class;
    }
}
