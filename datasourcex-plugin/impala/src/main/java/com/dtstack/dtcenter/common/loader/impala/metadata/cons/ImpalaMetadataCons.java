...
package com.dtstack.dtcenter.common.loader.impala.metadata.cons;
 ...
 * @date 2022/4/14
 */
public class ImpalaMetadataCons {

    public static final String DRIVER_NAME = "com.cloudera.impala.jdbc41.Driver";
    ...
    public static final String KEY_COL_OWNER = "Owner:";
    ...
    public static final String INVALID_META = "invalidate metadata %s";
    public static final String REFRESH_META = "refresh %s";
    public static final String SQL_QUERY_DATA = "describe formatted %s";
    public static final String SQL_SHOW_PARTITIONS = "show partitions %s";
    public static final String KEY_COLUMN_DATA_TYPE = "type";
    ...
    public static final String ANALYZE_TABLE = "compute stats %s";
