 ...
 * @date 2022/6/7
 */
public class ImpalaMetadataCollectManager extends RdbmsMetaDataCollectManager {
    public ImpalaMetadataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return ImpalaMetadataCollect.class;
    }
}
