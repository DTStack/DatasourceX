...
package com.dtstack.dtcenter.common.loader.iceberg.client;

import com.dtstack.dtcenter.common.loader.common.utils.SearchUtil;
import com.dtstack.dtcenter.common.loader.iceberg.pool.IcebergHiveCatalogManager;
import com.dtstack.dtcenter.common.loader.rdbms.AbsRdbmsClient;
import com.dtstack.dtcenter.common.loader.rdbms.ConnFactory;
import com.dtstack.dtcenter.loader.dto.ColumnMetaDTO;
import com.dtstack.dtcenter.loader.dto.SqlQueryDTO;
import com.dtstack.dtcenter.loader.dto.source.ISourceDTO;
import com.dtstack.dtcenter.loader.dto.source.IcebergSourceDTO;
...
public class IcebergClient extends AbsRdbmsClient {
    ...
    public Boolean testCon(ISourceDTO sourceDTO) {
        try {
            ...
            throw new DtLoaderException(String.format("test conn error, msg: %s", e.getMessage()), e);
        }
    }
