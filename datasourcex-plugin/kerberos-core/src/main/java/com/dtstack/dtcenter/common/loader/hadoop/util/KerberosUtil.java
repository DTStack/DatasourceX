...
public class KerberosUtil {
    ...
    public static void downloadAndReplace(Map<String, Object> kerberosConfig) {
        ...
        // 替换相对路径为绝对路径
        KerberosConfigUtil.changeRelativePathToAbsolutePath(kerberosConfig, kerberosPath, HadoopConfTool.PRINCIPAL_FILE);
        KerberosConfigUtil.changeRelativePathToAbsolutePath(kerberosConfig, kerberosPath, HadoopConfTool.KEYTAB_PATH);
        KerberosConfigUtil.changeRelativePathToAbsolutePath(kerberosConfig, kerberosPath, HadoopConfTool.KEY_JAVA_SECURITY_KRB5_CONF);
    }
