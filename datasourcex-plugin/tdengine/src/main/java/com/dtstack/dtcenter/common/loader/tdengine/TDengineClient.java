...
package com.dtstack.dtcenter.common.loader.tdengine;
...
public class TDengineClient extends AbsRdbmsClient {
    ...
    protected String getCreateDatabaseSql(String dbName, String comment) {
        if (dbName.length() > 32) {
            throw new DtLoaderException("max dbName is 32");
        }
        //不支持库注释
    ...
    public Boolean isTableExistsInDatabase(ISourceDTO source, String tableName, String dbName) {
        if (StringUtils.isBlank(tableName) || StringUtils.isBlank(dbName)) {
            throw new DtLoaderException("param can't be empty");
        }
    ...
    private List<String> getTableByType(ISourceDTO sourceDTO,
        ...
        try {
            ...
            throw new DtLoaderException("getTableByType error ", e);
        } finally {
            if (needClose) {
                try {
    ...
    public List<String> getTableListBySchema(ISourceDTO source, SqlQueryDTO queryDTO) {
        ...
        if (StringUtils.isBlank(schema)) {
            ...
            try {
                ...
                throw new DtLoaderException(String.format("use db : %s error.", schema), e);
            }
        }
