...
package com.dtstack.dtcenter.common.loader.starrocks.util;
...
public final class DataSize implements Comparable<DataSize> {
    ...
    public static DataSize parse(CharSequence text,DataUnit defaultUnit) {
        ...
        try {
            ...
            if (!matcher.matches()) {
                throw new RuntimeException("Does not match data size pattern");
            }
    ...
    private static DataUnit determineDataUnit(String suffix, DataUnit defaultUnit) {
        ...
        return (!StringUtils.isEmpty(suffix) ? DataUnit.fromSuffix(suffix) : defaultUnitToUse);
    }
