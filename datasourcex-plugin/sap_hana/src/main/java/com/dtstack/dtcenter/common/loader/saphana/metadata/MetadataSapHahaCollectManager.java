 ...
 *
 * @author by zhiyi
 * @date 2022/4/8 10:09 上午
 */
public class MetadataSapHahaCollectManager extends RdbmsMetaDataCollectManager {

    public MetadataSapHahaCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return SaphanaMetadataCollect.class;
    }
}
