...
package com.dtstack.dtcenter.common.loader.hdfs.downloader.tableDownload;

import com.dtstack.dtcenter.common.loader.common.utils.HiveUtil;
import com.dtstack.dtcenter.common.loader.common.utils.ListUtil;
import com.dtstack.dtcenter.common.loader.hadoop.hdfs.HdfsOperator;
import com.dtstack.dtcenter.common.loader.hadoop.util.KerberosLoginUtil;
import com.dtstack.dtcenter.common.loader.common.downloader.AbstractDownloader;
 ...
 */
@Slf4j
public class HiveTextDownload extends AbstractDownloader {
    ...
    private void readFromFileIfEmpty(List<String> columnNames, FileSystem fs) throws IOException {
        ...
        if (!fs.exists(schemaPath) || fs.getFileStatus(schemaPath).getLen() == 0) {
            throw new DtLoaderException(String.format("column schema file path %s is not exists or size is 0", schemaPath));
        }
