...
import com.dtstack.dtcenter.common.loader.hdfs.downloader.tableDownload.HiveCsvDownload;
...
import com.dtstack.dtcenter.common.loader.hdfs.reader.ReaderFactory;
...
public class HdfsFileClient implements IHdfsFile {
    ...
    public List<String> getTaskManagerList(ISourceDTO source, String submitUser, String appId) {
        ...
        hdfsSourceDTO.setUser(submitUser);
     ...
     */
    private AbstractYarnDownloader createYarnLogDownload(HdfsSourceDTO hdfsSourceDTO) throws Exception {
