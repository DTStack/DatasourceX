...
public class SqlServerMetaDataCollcetManager extends RdbmsMetaDataCollectManager {

    public SqlServerMetaDataCollcetManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return SqlServerMetaDataCollect.class;
    }
}
