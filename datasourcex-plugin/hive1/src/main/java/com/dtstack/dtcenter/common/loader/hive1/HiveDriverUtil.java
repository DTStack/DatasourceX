...
import static com.dtstack.dtcenter.common.loader.hive1.metadata.cons.HiveCons.ORC_FORMAT;
import static com.dtstack.dtcenter.common.loader.hive1.metadata.cons.HiveCons.PARQUET_FORMAT;
import static com.dtstack.dtcenter.common.loader.hive1.metadata.cons.HiveCons.TEXT_FORMAT;
import static com.dtstack.dtcenter.common.loader.hive1.metadata.cons.HiveCons.TYPE_ORC;
import static com.dtstack.dtcenter.common.loader.hive1.metadata.cons.HiveCons.TYPE_PARQUET;
import static com.dtstack.dtcenter.common.loader.hive1.metadata.cons.HiveCons.TYPE_TEXT;

/**
 * @company: www.dtstack.com
 * @Author ：Nanqi
 * @Date ：Created in 16:02 2020/12/23
...
public class HiveDriverUtil {
    ...
    private static DriverPropertyInfo[] parseProperty(String url, Properties properties) {
        try {
            ...
            throw new DtLoaderException(String.format("Hive parsing URL exception : %s", e.getMessage()), e);
        }
    }
