 ...
 */
@Slf4j
public class HiveJdbcDownload extends AbstractDownloader {
    /**
     * 执行的 sql
     */
    ...
    public HiveJdbcDownload(Connection connection, String sql) {
    ...
    public boolean configure() throws Exception {
        ...
        if (null == connection || StringUtils.isEmpty(sql)) {
            throw new DtLoaderException("connection acquisition failed or execution SQL is empty");
        }
    ...
    public List<String> readNext() {
        if (!lineQueue.isEmpty()) {
            ...
            try (ResultSet resultSet = statement.executeQuery(limitSQL)) {
                ...
                throw new DtLoaderException("read message exception : " + e.getMessage(), e);
            }
        }
    }
