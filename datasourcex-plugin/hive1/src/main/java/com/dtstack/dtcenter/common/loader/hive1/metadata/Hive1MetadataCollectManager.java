 ...
 * @date 2022/4/14
 */
public class Hive1MetadataCollectManager extends RdbmsMetaDataCollectManager {
    public Hive1MetadataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return Hive1MetadataCollect.class;
    }
}
