 ...
 * @date 2022/4/11
 */
public class MetadataDorisCollectManager extends RdbmsMetaDataCollectManager {

    public MetadataDorisCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return DorisMetadataCollect.class;
    }
}
