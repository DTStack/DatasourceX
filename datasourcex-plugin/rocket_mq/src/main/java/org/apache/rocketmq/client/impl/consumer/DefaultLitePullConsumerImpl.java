...
public class DefaultLitePullConsumerImpl implements MQConsumerInner {
    ...
    public synchronized void assign(Collection<MessageQueue> messageQueues, String topic, String subExpression) {
        //
        try {
            SubscriptionData subscriptionData = FilterAPI.buildSubscriptionData(topic, subExpression);
        ...
        public void run() {
            ...
            if (!this.isCancelled()) {
                ...
                try {
                    ...
                    if (subscriptionType == SubscriptionType.SUBSCRIBE || subscriptionType == SubscriptionType.ASSIGN) {
