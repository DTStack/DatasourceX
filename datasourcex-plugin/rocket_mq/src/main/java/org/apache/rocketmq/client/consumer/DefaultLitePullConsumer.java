...
public class DefaultLitePullConsumer extends ClientConfig implements LitePullConsumer {
    ...
    @Override
    public void assign(Collection<MessageQueue> messageQueues, String topic, String subExpression) {
        defaultLitePullConsumerImpl.assign(queuesWithNamespace(messageQueues),topic,subExpression);
    }
