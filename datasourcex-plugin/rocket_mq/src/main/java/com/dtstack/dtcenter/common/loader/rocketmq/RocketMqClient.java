...
/**
 * @author leon
 * @date 2022-06-20 15:13
 **/
public class RocketMqClient extends AbsNoSqlClient {

    @Override
    public Boolean testCon(ISourceDTO sourceDTO) {
        RocketMqSourceDTO rocketMqSourceDTO = (RocketMqSourceDTO) sourceDTO;
        return RocketMqUtils.checkConnection(rocketMqSourceDTO);
    }
}
