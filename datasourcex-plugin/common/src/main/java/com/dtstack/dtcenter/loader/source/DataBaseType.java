...
public enum DataBaseType {
    ...
    TDengine("Tdengine","com.taosdata.jdbc.rs.RestfulDriver","select 111"),
    HIVE_CDC("hive_cdc","org.apache.hive.jdbc.HiveDriver"),
    STAR_ROCKS("starrocks", "com.mysql.jdbc.Driver", "select 1"),
    ;
