...
public abstract class AbsTableClient implements ITable {
    ...
    public Long getTableSize(ISourceDTO source, String schema, String tableName) {
        ...
        Object tableSize = result.get(0).values().stream().findFirst().orElseThrow(() -> new DtLoaderException("Get the table occupation storage information exception"));
