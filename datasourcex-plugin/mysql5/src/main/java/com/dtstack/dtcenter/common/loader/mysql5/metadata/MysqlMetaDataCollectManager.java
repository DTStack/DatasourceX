...
/**
 * mysql metadata collect manager
 *
 * @author ：wangchuan
 * date：Created in 下午10:59 2022/4/6
 * company: www.dtstack.com
 */
public class MysqlMetaDataCollectManager extends RdbmsMetaDataCollectManager {

    public MysqlMetaDataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return MysqlMetadataCollect.class;
    }
}
