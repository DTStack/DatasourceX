 ...
 * @date 2022/4/15
 */
public class InceptorMetadataCollectManager extends RdbmsMetaDataCollectManager {
    public InceptorMetadataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return InceptorMetadataCollect.class;
    }
}
