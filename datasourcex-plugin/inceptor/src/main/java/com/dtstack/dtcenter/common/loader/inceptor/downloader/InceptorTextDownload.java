...
@Slf4j
public class InceptorTextDownload extends AbstractDownloader {
    ...
    public InceptorTextDownload(Configuration configuration, String tableLocation, List<String> columnNames, String fieldDelimiter,
