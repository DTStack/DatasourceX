...
package com.dtstack.dtcenter.common.loader.trino.download;
 ...
 * date 2022年05月23日
 */
public class TrinoDownloader extends AbstractDownloader {
    ...
    public boolean configure() throws Exception {
        ...
        try {
            ...
            throw new DtLoaderException("build trino downloader message exception : " + e.getMessage(), e);
        } finally {
    ...
    public List<List<String>> readNext() {
        ...
        try (ResultSet resultSet = statement.executeQuery(limitSQL)) {
            ...
            throw new DtLoaderException("read trino message exception : " + e.getMessage(), e);
        }
