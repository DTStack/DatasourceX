...
public class VerticaMetaDataCollectManager extends RdbmsMetaDataCollectManager {

    public VerticaMetaDataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return VerticaMetaDataCollect.class;
    }
}
