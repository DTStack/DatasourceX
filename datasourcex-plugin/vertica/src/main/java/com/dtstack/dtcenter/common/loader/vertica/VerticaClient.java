...
import com.dtstack.dtcenter.common.loader.vertica.metadata.VerticaMetaDataCollectManager;
...
public class VerticaClient extends AbsRdbmsClient {
    ...
    public List<String> getTableList(ISourceDTO sourceDTO, SqlQueryDTO queryDTO) {
        ...
        try {
            List<Map<String, Object>> mapList = DBUtil.executeSql(connection, SHOW_TABLES);
    ...
    public MetaDataCollectManager getMetadataCollectManager(ISourceDTO sourceDTO) {
        return new VerticaMetaDataCollectManager(sourceDTO);
    }
}
