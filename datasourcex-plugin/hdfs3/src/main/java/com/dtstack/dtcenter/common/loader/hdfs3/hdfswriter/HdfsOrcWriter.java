...
package com.dtstack.dtcenter.common.loader.hdfs3.hdfswriter;
...
import com.dtstack.dtcenter.common.loader.hdfs3.OrcColumnTypeConverter;
...
public class HdfsOrcWriter {
    ...
    public static int writeByPos(ISourceDTO source, HdfsWriterDTO hdfsWriterDTO) throws IOException {
        ...
        try {
            ...
            while (reader.readRecord()) {
                ...
                for (int i = 0; i < size; i++) {
                    try {
                        ...
                        throw new DtLoaderException(String.format("convert error, dataType : %s , dataValue : %s",
            ...
            throw new DtLoaderException("The" + (currLineNum - (topLineIsTitle ? 1 : 0))
    ...
    public static int writeByName(ISourceDTO source, HdfsWriterDTO hdfsWriterDTO) throws IOException {
        ...
        try {
            ...
            throw new DtLoaderException("The" + currLineNum
                    + " row of data is abnormal, please check , detail: " + e.getMessage(), e);
        } finally {
            try {
                if (writer != null) {
