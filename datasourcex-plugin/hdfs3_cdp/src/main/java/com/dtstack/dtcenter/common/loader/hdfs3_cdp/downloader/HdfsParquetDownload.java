...
import com.dtstack.dtcenter.common.loader.hdfs3_cdp.GroupTypeIgnoreCase;
 ...
 */
@Slf4j
public class HdfsParquetDownload extends AbstractDownloader {
    ...
    public HdfsParquetDownload(Configuration conf, String tableLocation, List<ColumnMetaDTO> columns,
