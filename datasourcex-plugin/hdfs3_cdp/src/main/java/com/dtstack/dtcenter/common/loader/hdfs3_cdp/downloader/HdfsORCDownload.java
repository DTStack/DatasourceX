...
package com.dtstack.dtcenter.common.loader.hdfs3_cdp.downloader;
 ...
 */
@Slf4j
public class HdfsORCDownload extends AbstractDownloader {
    ...
    public HdfsORCDownload(Configuration configuration, String tableLocation, List<String> columnNames,
    ...
    public boolean configure() throws Exception {
        ...
        if (CollectionUtils.isNotEmpty(partitions)) {
            Path[] paths = partitions.stream().map(part -> new Path(tableLocation + "/" + part)).toArray(Path[]::new);
