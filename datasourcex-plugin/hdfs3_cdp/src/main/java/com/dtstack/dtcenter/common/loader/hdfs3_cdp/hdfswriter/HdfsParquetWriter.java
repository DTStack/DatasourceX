...
package com.dtstack.dtcenter.common.loader.hdfs3_cdp.hdfswriter;
...
public class HdfsParquetWriter {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    switch (type) {
                        ...
                        case "boolean":
                            ...
                            break;
                        case "timestamp":
                            Timestamp ts = Timestamp.ofEpochMilli(getTime(val, hdfsWriterDTO.getKeyList().get(i).getDateFormat()));
    ...
    private static ParquetWriter<Group> getWriter(Hdfs3SourceDTO sourceDTO, String hdfsDirPath, List<ColumnMetaDTO> columnsList) throws IOException {
