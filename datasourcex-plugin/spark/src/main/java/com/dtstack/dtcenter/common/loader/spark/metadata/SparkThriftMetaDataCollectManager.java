...
public class SparkThriftMetaDataCollectManager extends RdbmsMetaDataCollectManager {

    public SparkThriftMetaDataCollectManager(ISourceDTO sourceDTO) {
        super(sourceDTO);
    }

    @Override
    protected Class<? extends MetaDataCollect> getMetadataCollectClass() {
        return SparkThriftMetaDataCollect.class;
    }
}
