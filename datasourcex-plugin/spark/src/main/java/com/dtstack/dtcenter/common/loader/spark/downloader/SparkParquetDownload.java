 ...
 */
@Slf4j
public class SparkParquetDownload extends AbstractDownloader {
    ...
    public SparkParquetDownload(Configuration conf, String tableLocation,List<ColumnMetaDTO> columns,
