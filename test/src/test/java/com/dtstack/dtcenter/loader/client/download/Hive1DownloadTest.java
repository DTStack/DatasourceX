...
@Slf4j
@Ignore
public class Hive1DownloadTest extends BaseTest {

    /**
     * 构造 hive 客户端
     */
    private static final IClient HIVE_CLIENT = ClientCache.getClient(DataSourceType.HIVE1X.getVal());
     ...
     * 本地文件路径
     */
    private static final String FILE_PATH = Hive1DownloadTest.class.getResource("/download").getPath();

    /**
     * 构建 HIVE 数据源信息
     */
    private static final Hive1SourceDTO HIVE_SOURCE_DTO = Hive1SourceDTO.builder()
